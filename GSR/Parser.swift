...
class Parser {
    ...
    static func getAvailableTimeSlots(_ rawHTML : String) -> Dictionary<String, [Hour]> {
        
        var timeSlots = Dictionary<String, [Hour]>()
        ...
        for tag in aTags {
            ...
            let hour = Hour(id: Int(id)!, start: start, end: end, prev: nil)
